...
def compute_per_class_accuracy(
    ...
    For each label, counts how many episodes with that ground-truth label were predicted correctly.
    Returns accuracy of 0.0 for any class with no examples in ground_truth.
    """
